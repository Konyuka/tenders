         ...
         <nav class="mb-4 flex" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <div class="flex items-center">
                    ...
                    <span class="ml-1 text-sm font-medium text-gray-400 md:ml-2 dark:text-gray-500">Payments Page</span>
                </div>
                </li>
            </ol>
        </nav>
                ...
                <table class="min-w-full bg-white dark:bg-gray-800">
                    <thead>
                        <tr class="w-full h-16 border-gray-300 border-b py-8">
                            ...
                            <th class="text-gray-600 dark:text-gray-400 font-normal pr-6 text-left text-sm tracking-normal leading-4">Amount Paid</th>
                            ...
                            <th class="text-gray-600 dark:text-gray-400 font-normal pr-6 text-left text-sm tracking-normal leading-4">Paid By</th>
                    ...
                    <tbody class="">
                        <tr class="h-24 border-gray-300 border-b">
                            ...
                            <td class="text-sm pr-6 whitespace-no-wrap text-gray-800 dark:text-gray-100 tracking-normal leading-4">KES <span class="font-bold text-green-600">100</span> </td>
                            ...
                            <td class="pr-8 relative">
                                ...
                                <button class="mx-4 text-indigo-600 hover:text-indigo-400 rounded cursor-pointer border border-transparent focus:outline-none">
