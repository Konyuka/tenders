        ...
        <div class="">
          <section class="text-gray-600 body-font overflow-hidden">
            <div class="container px-5 py-10 mx-auto">
              <div ref="container" class="lg:w-4/5 mx-auto flex flex-wrap">
                <button @click="downloadPDF"
                  type="button"
                    class="mt-2 inline-flex w-full justify-center rounded-md border border-transparent bg-indigo-600 px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 sm:w-auto sm:text-sm">
                    Download as PDF
                  </button>
                <div ref="content" class="w-full h-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
                  <a href="#" class="text-sm title-font text-gray-500 tracking-widest"
                    >Tender Brief</a
                  >
                  <h1
                  ...
                  <div class="text-sm sm:text-lg flex border-t border-indigo-300 py-2">
                    <span class="text-gray-500 font-extrabold font-heading-font"
                      ><i class="mr-10 fas fa-angles-right text-indigo-600"></i> Tender
                      Number</span
                    >
                  ...
                  <div class="text-sm sm:text-lg flex border-t border-indigo-300 py-2">
                    <span class="text-gray-500 font-extrabold font-heading-font"
                      ><i class="mr-10 fas fa-angles-right text-indigo-600"></i> Competition
                      Type</span
                    >
                    <span class="ml-auto text-gray-900">
                      <span class="ml-auto text-gray-900 font-primary-font">
                  ...
                  <div class="text-sm sm:text-lg flex border-t border-indigo-300 py-2">
                    <span class="text-gray-500 font-extrabold font-heading-font"
                      ><i class="mr-10 fas fa-angles-right text-indigo-600"></i> Funded
                      By</span
                    >
                    <span class="ml-auto text-gray-900 font-primary-font">
                      {{ post.funded_by }}
                  ...
                  <div class="text-sm sm:text-lg flex border-t border-indigo-300 py-2">
                    <span class="text-gray-500 font-extrabold font-heading-font"
                      ><i class="mr-10 fas fa-angles-right text-indigo-600"></i> Contact
                      Email</span
                    >
                    <span class="ml-auto text-gray-900 font-primary-font">
                      {{ post.email }}
                  ...
                  <div class="text-sm sm:text-lg flex border-t border-indigo-300 py-2">
                    <span class="text-gray-500 font-extrabold font-heading-font"
                      ><i class="mr-10 fas fa-angles-right text-indigo-600"></i> Physical
                      Address</span
                    >
                    <span class="ml-auto text-gray-900 font-primary-font">
                      {{ post.address }}
                  ...
                  <div class="text-sm sm:text-lg flex border-t mb-6 border-indigo-300 py-2">
                    <span class="text-gray-500 font-extrabold font-heading-font"
                      ><i class="mr-10 fas fa-angles-right text-indigo-600"></i>
                      Date Posted
                      <span
  ...
  methods: {
    ...
    downloadTender() {
      SejdaJsApi.htmlToPdf({
        filename: this.post.purchasing_authority + ".pdf",
        pageSize: "a4",
        publishableKey: "api_public_01c16347c53a44a5bb741042966b6296",
        url: this.post.link,
        always: function () {
