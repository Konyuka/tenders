    ...
    <div class="overflow-y-hidden antialiased">
        ...
        <section class="text-gray-600 body-font overflow-hidden">
            ...
            <div class="w-full h-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
                ...
                <h1 class="text-indigo-500 text-md title-font font-bold my-2">{{ post.purchasing_authority }}</h1>
                ...
                <span class="text-gray-500">Tender Number</span>
                ...
                <span class="ml-auto text-gray-900">
                    ...
                    <!-- <a class="bg-indigo-400 hover:bg-indigo-600 text-white  text-sm font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-blue-200 dark:text-blue-800"></a> -->
                </span>
                </div>
                <div class="flex border-t mb-6 border-gray-200 py-2">
                ...
                <div class="flex border-t  mb-6 border-gray-200 py-2">
                <span class="text-gray-500">Contact Address</span>
                <span class="ml-auto text-gray-900">
                    {{ post.address }}
                </span>
                </div>
                ...
                <button class="flex ml-auto text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-700 rounded">Download Tender Documents</button>
                </a>
                <!-- <button @click="downloadTender" class="flex ml-auto text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-700 rounded">Download Tender Documents</button> -->
