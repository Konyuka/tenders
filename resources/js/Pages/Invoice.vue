<template>
    <div class="relative h-screen verflow-y-hidden bg-gradient-to-r from-indigo-400 to-indigo-800">
        <MainMenu class="sticky top-0" />

        <div class=""></div>

        <div class="py-14 px-4 md:px-6 2xl:px-20 2xl:container 2xl:mx-auto">
            <div class="right-0 flex justify-center items-center space-y-2 flex-col">
                ...
                <div>
                    ...
                    <p class="font-primary-font text-base dark:text-gray-300 font-medium leading-6 text-gray-300">
                        ...
                        <div
                            ...
                            <div class="flex justify-between items-start w-full">
                                <div class="flex justify-center items-center space-x-4">
                                    <div class="w-20 h-20">
                                        <img class="w-full h-full" alt="logo" :src="'/img/mpesa.jpeg'" />
                                    </div>
                                    <div class="flex flex-col justify-start items-center">
                                        <p
                                            class="font-heading-font text-2xl leading-6 dark:text-white font-semibold text-green-700">
                                            M-Pesa<br /><span
                                                class="font-normal text-sm font-primary-font text-black">Mpesa
                                                Express</span>
                                        </p>
                                    </div>
                                </div>
        ...
        <div v-if="expressModal" class="relative z-10" aria-labelledby="modal-title" role="dialog" aria-modal="true">
                    ...
                    <div
                        ...
                        <div>
                            ...
                            <div class="mt-3 text-center sm:mt-5">
                                <div class="mt-2">
                                    <label for="email2"
                                        class="text-gray-800 text-sm font-bold leading-tight tracking-normal text-center">M-Pesa
                                        Payment Number</label>
                                    <div class="relative mb-5 mt-2">
                                        <div class="absolute text-gray-600 flex items-center px-4 border-r h-full">
                                            <i class="fas fa-phone fa-xl text-indigo-600"></i>
                                        </div>
                                        <input v-model="form.number" id="mobile" type="number"
                                    ...
                                    <div class="flex items-center justify-around w-full">
                                        ...
                                        <button @click="expressModal = false"
        ...
        <!-- For Mobile     -->
        <div v-if="paymentModal" class="flex sm:hidden relative z-10" aria-labelledby="modal-title" role="dialog"
            aria-modal="true">
            <div class="fixed inset-0 bg-gray-500 bg-opacity-75 transition-opacity"></div>
                    ...
                    <div
                        ...
                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                            ...
                            <div class="flex justify-end p-2">
                                <a v-if="status == 'Cancelled'" @click="closeSTK" class="hover:cursor-pointer">
                                    <!-- <a
                        ...
                        > -->
                            ...
                            <div class="flex flex-col px-10">
                                <h4 v-if="status != 'Cancelled'"
                                    class="mb-5 text-sm font-bold text-gray-500 dark:text-gray-400">
                                    Phone Number:
                                    <span class="ml-2 font-extrabold text-md sm:text-xl text-indigo-600">
                    ...
                    <button @click="stkPush" data-modal-toggle="popup-modal" type="button" class="text-white bg-indigo-400 hover:bg-green-500 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2">
                        ...
                        >
                            Restart Mpesa Express Payment
                                ...
                                <!-- <button v-if="status != 'Cancelled'" @click="confirm" data-modal-toggle="popup-modal"
                                    type="button"
        ...
        <div v-if="paymentModal" id="popup-modal" tabindex="-1"
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="flex flex-col px-10">
                        <h4 v-if="status != 'Cancelled'"
                            class="mb-5 text-sm font-bold text-gray-500 dark:text-gray-400">
                            Phone Number:
                            <span class="ml-2 font-extrabold text-xl text-indigo-600">
                                {{ this.form.number }}</span>
                        </h4>
                    </div>
                    <div class="p-4 pt-0 text-center mt-5">
                        <div v-if="status != 'Cancelled' && !timeout" id="timer" class="mb-4">
                            <!-- <span id="minutes">{{ minutes | twoDigits }}</span> -->
                            <!-- <span id="middle">:</span> -->
                            <span id="seconds" class="font-extrabold text-indigo-700 font-primary-font text-lg">{{
                                    seconds | twoDigits
                            }} Seconds</span>
                        </div>
                        <!-- <button v-if="status != 'Cancelled' && timeout == false" @click="confirm"
                            data-modal-toggle="popup-modal" type="button"
                            class="text-white bg-indigo-600 hover:bg-green-500 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2">
                            Tap at intervals to Confirm Payment
                        </button> -->
                        <button v-if="timeout" @click="closeSTK" data-modal-toggle="popup-modal" type="button"
    ...
    methods: {
        ...
        stkPush() {
            ...
            if (strFirstThree == 254 && this.form.number.length == 12) {
                ...
                axios.post(`/invoice/payment/stkPush`, requestBody)
                    .then(response => {
