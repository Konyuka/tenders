            ...
            <div class="flex w-full">
                <div class="w-1/4 flex justify-center flex-col w-full">
                    ...
                    <ul aria-orientation="vertical" class="rounded py-8 mt-4">
                        <li class="cursor-pointer text-sm leading-3 tracking-normal py-1 hover:text-indigo-700 focus:text-indigo-700 focus:outline-none">
                        ...
                        <li class="cursor-pointer text-sm leading-3 tracking-normal mt-6 py-1 hover:text-indigo-700 focus:text-indigo-700 focus:outline-none flex items-center">
                ...
                <div class="w-3/4 flex justify-start flex-col pr-12 transition duration-150 ease-in-out" id="mobile-nav">
                    ...
                    <ul aria-orientation="vertical" class="rounded py-8">
                        ...
                        <li @click="selectedMenu('payments')" :class="this.currentMenu == 'payments' ? 'text-indigo-700' : ''" class="cursor-pointer text-gray-600 text-sm leading-3 tracking-normal mt-6 py-2 hover:text-indigo-700 focus:text-indigo-700 focus:outline-none flex items-center">
                            <span class="ml-2">Payments</span>
                        </li>
                        <li @click="selectedMenu('support')" :class="this.currentMenu == 'support' ? 'text-indigo-700' : ''" class="cursor-pointer text-gray-600 text-sm leading-3 tracking-normal mt-6 py-2 hover:text-indigo-700 flex items-center focus:text-indigo-700 focus:outline-none">
                            <span class="ml-2">Support</span>
                        </li>
                        <li @click="selectedMenu('users')" :class="this.currentMenu == 'users' ? 'text-indigo-700' : ''" class="cursor-pointer text-gray-600 text-sm leading-3 tracking-normal mt-6 py-2 hover:text-indigo-700 flex items-center focus:text-indigo-700 focus:outline-none">
                            ...
                            <div class="flex items-center relative cursor-pointer" @click="dropdownHandler($event)">
                                <div class="rounded-full">
                                    <ul class="p-2 w-full border-r bg-white absolute rounded left-0 shadow mt-12 sm:mt-16 hidden">
                                        <a :href="route('profile.show')" class="flex w-full justify-between text-gray-600 hover:text-indigo-700 cursor-pointer items-center">
                                            <div class="flex items-center">
                                        ...
                                        <li @click="logout" class="flex w-full justify-between text-gray-600 hover:text-indigo-700 cursor-pointer items-center mt-2">
                                            <div class="flex items-center">
