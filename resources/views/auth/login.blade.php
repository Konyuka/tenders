    ...
    <x-guest-layout>
        <section
            class="relative py-40 2xl:py-40 bg-gradient-to-r from-indigo-300 to-indigo-500 overflow-hidden h-screen">
                ...
                <div class="max-w-5xl mx-auto">
                    <div class="flex flex-wrap items-center -mx-4">
                        <div class="w-full lg:w-1/2 px-4 mb-16 lg:mb-0">
                            <div class="max-w-md">
                                <a href="/"
                                    class="mt-8 mb-12 text-6xl font-bold font-heading font-heading-font text-white"> <i
                                        class="fas fa-caret-left"></i> Bidders Portal</a>
                        ...
                        <div class="w-full lg:w-1/2 px-4">
                            ...
                            <div
                                class="px-6 lg:px-20 py-12 lg:py-12 bg-gradient-to-r from-indigo-500 to-indigo-800 rounded-lg">
                                <form method="POST" action="{{ route('login') }}">
                                    @csrf
                                    <h3 class="mb-10 text-2xl text-white font-bold font-heading">Sign in to your Account
                                    </h3>
                                    ...
                                    <button type="submit"
                                        class="py-4 w-full bg-indigo-700 hover:bg-blue-600 text-white font-bold rounded-full transition duration-200">Sign
                                        In</button>
